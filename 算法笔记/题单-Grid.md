---
title: 网格图题单
aliases: [网格图（DFS/BFS/综合应用）, 灵神网格图题单]
tags:
  - leetcode
  - grid
  - dfs
...
original: https://leetcode.cn/circle/discuss/YiXPXW
last_update: 2025-09-26 04:19:54
---

# 网格图（DFS/BFS/综合应用）

来源：https://leetcode.cn/circle/discuss/YiXPXW
更新：2025-09-26 04:19:54
...
- [ ] [2061. 扫地机器人清扫过的空间个数](https://leetcode.cn/problems/number-of-spaces-cleaning-robot-cleaned/)（会员题）
...
- [ ] [3286. 穿越网格图的安全路径](https://leetcode.cn/problems/find-a-safe-walk-through-a-grid/) 1608
...
- [x] [1824. 最少侧跳次数](https://leetcode.cn/problems/minimum-sideway-jumps/) 1778
- [ ] [LCP 56. 信物传送](https://leetcode.cn/problems/6UEx57/)

## 四、网格图 Dijkstra

> 见 [图论题单](/lc-rating/v0/list/graph) 中的 Dijkstra。
