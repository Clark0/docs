---
title: 链表、树与回溯题单
aliases: [链表、二叉树与回溯（前后指针/快慢指针/DFS/BFS/直径/LCA/一般树）, 灵神链表、树与回溯题单]
tags:
  - leetcode
  - tree
  - linked-list
...
original: https://leetcode.cn/circle/discuss/K0n2gO
last_update: 2025-11-23 22:46:39
---

# 链表、二叉树与回溯（前后指针/快慢指针/DFS/BFS/直径/LCA/一般树）

来源：https://leetcode.cn/circle/discuss/K0n2gO
更新：2025-11-23 22:46:39
...
- [ ] [1290. 二进制链表转整数](https://leetcode.cn/problems/convert-binary-number-in-a-linked-list-to-integer/) 1151
- [ ] [2058. 找出临界点之间的最小和最大距离](https://leetcode.cn/problems/find-the-minimum-and-maximum-number-of-nodes-between-critical-points/) 1311
- [ ] [2181. 合并零之间的节点](https://leetcode.cn/problems/merge-nodes-in-between-zeros/) 1333
- [ ] [725. 分隔链表](https://leetcode.cn/problems/split-linked-list-in-parts/)
- [ ] [817. 链表组件](https://leetcode.cn/problems/linked-list-components/) 1429
...
- [ ] [3217. 从链表中移除在数组中存在的节点](https://leetcode.cn/problems/delete-nodes-from-linked-list-present-in-array/) 1342
- [ ] [83. 删除排序链表中的重复元素](https://leetcode.cn/problems/remove-duplicates-from-sorted-list/)
- [ ] [82. 删除排序链表中的重复元素 II](https://leetcode.cn/problems/remove-duplicates-from-sorted-list-ii/)
- [ ] [237. 删除链表中的节点](https://leetcode.cn/problems/delete-node-in-a-linked-list/)
- [ ] [1669. 合并两个链表](https://leetcode.cn/problems/merge-in-between-linked-lists/) 1428
- [ ] [2487. 从链表中移除节点](https://leetcode.cn/problems/remove-nodes-from-linked-list/) 1455
...
- [ ] [2074. 反转偶数长度组的节点](https://leetcode.cn/problems/reverse-nodes-in-even-length-groups/) 1685
...
- [ ] [1721. 交换链表中的节点](https://leetcode.cn/problems/swapping-nodes-in-a-linked-list/) 1387
...
- [ ] [2816. 翻倍以链表形式表示的数字](https://leetcode.cn/problems/double-a-number-represented-as-a-linked-list/) 1394
...
- [ ] [1171. 从链表中删去总和值为零的连续节点](https://leetcode.cn/problems/remove-zero-sum-consecutive-nodes-from-linked-list/) 1782
...
- [ ] [1214. 查找两棵二叉搜索树之和](https://leetcode.cn/problems/two-sum-bsts/) 1389（会员题）
...
- [ ] [971. 翻转二叉树以匹配先序遍历](https://leetcode.cn/problems/flip-binary-tree-to-match-preorder-traversal/) 1787
...
- [ ] [951. 翻转等价二叉树](https://leetcode.cn/problems/flip-equivalent-binary-trees/) 1477
...
- [ ] [1530. 好叶子节点对的数量](https://leetcode.cn/problems/number-of-good-leaf-nodes-pairs/) 1746
...
- [ ] [1120. 子树的最大平均值](https://leetcode.cn/problems/maximum-average-subtree/) 1362（会员题）
...
- [ ] [1038. 从二叉搜索树到更大和树](https://leetcode.cn/problems/binary-search-tree-to-greater-sum-tree/) 1375
...
- [ ] [1305. 两棵二叉搜索树中的所有元素](https://leetcode.cn/problems/all-elements-in-two-binary-search-trees/) 1260
...
- [ ] [1382. 将二叉搜索树变平衡](https://leetcode.cn/problems/balance-a-binary-search-tree/) 1541
...
- [ ] [776. 拆分二叉搜索树](https://leetcode.cn/problems/split-bst/) 1810（会员题）
- [ ] [1666. 改变二叉树的根节点](https://leetcode.cn/problems/change-the-root-of-a-binary-tree/)（会员题）

### §2.12 树形 DP

> 更多树形 DP，见 [动态规划题单](/lc-rating/v0/list/dynamic_programming) 中的「树形 DP」。
...
- [ ] [2458. 移除子树后的二叉树高度](https://leetcode.cn/problems/height-of-binary-tree-after-subtree-removal-queries/) 2299
...
- [ ] [1273. 删除树节点](https://leetcode.cn/problems/delete-tree-nodes/) 1733（会员题）
...
- [ ] [1245. 树的直径](https://leetcode.cn/problems/tree-diameter/) 1792（会员题）
...
- [ ] [1483. 树节点的第 K 个祖先](https://leetcode.cn/problems/kth-ancestor-of-a-tree-node/) 2115
- [ ] [3559. 给边赋权值的方案数 II](https://leetcode.cn/problems/number-of-ways-to-assign-edge-weights-ii/) 2146
- [ ] [3553. 包含给定路径的最小带权子树 II](https://leetcode.cn/problems/minimum-weighted-subgraph-with-the-required-paths-ii/) 2411
...
> 另见 [动态规划题单](/lc-rating/v0/list/dynamic_programming) 中的「**树形 DP**」，包含换根 DP。
...
- [ ] [2094. 找出 3 位偶数](https://leetcode.cn/problems/finding-3-digit-even-numbers/) 1455
- [ ] [1415. 长度为 n 的开心字符串中字典序第 k 小的字符串](https://leetcode.cn/problems/the-k-th-lexicographical-string-of-all-happy-strings-of-length-n/) 1576
...
- [ ] [1088. 易混淆数 II](https://leetcode.cn/problems/confusing-number-ii/) 2077（会员题）
...
- [ ] [1545. 找出第 N 个二进制字符串中的第 K 位](https://leetcode.cn/problems/find-kth-bit-in-nth-binary-string/) 1479
