---
title: 数学算法题单
aliases: [数学算法（数论/组合/概率期望/博弈/计算几何/随机算法）, 灵神数学算法题单]
tags:
  - leetcode
  - math
  - algorithm
...
original: https://leetcode.cn/circle/discuss/IYT3ss
last_update: 2025-10-16 23:03:35
---

# 数学算法（数论/组合/概率期望/博弈/计算几何/随机算法）

来源：https://leetcode.cn/circle/discuss/IYT3ss
更新：2025-10-16 23:03:35
...
> for (int i = 2; i  primes;
> auto init = [] {
> ranges::fill(is_prime,...
...
> }
> initialized = true;
> for (int i = 2; i  primeFactorization(int x) {
...
- [ ] [3715. 完全平方数的祖先个数总和](https://leetcode.cn/problems/sum-of-perfect-square-ancestors/) 2235
...
> private static final List[] divisors = new ArrayList[MX];
> private static boolean initialized = false;
> // 这样写比 static block 更快
> private void init() {
> if (initialized) {
...
- [ ] [3447. 将元素分配给有约束条件的组](https://leetcode.cn/problems/assign-elements-to-groups-with-constraints/) 1731
- [ ] [3164. 优质数对的总数 II](https://leetcode.cn/problems/find-the-number-of-good-pairs-ii/) 1777
- [ ] [2176. 统计数组中相等且可以被整除的数对](https://leetcode.cn/problems/count-equal-and-divisible-pairs-in-an-array/) 1216
...
- [ ] [3312. 查询排序后的最大公约数](https://leetcode.cn/problems/sorted-gcd-pair-queries/) 2533
...
- [ ] [1447. 最简分数](https://leetcode.cn/problems/simplified-fractions/) 1269
...
- [ ] [1015. 可被 K 整除的最小整数](https://leetcode.cn/problems/smallest-integer-divisible-by-k/) 1875
- [ ] [2240. 买钢笔和铅笔的方案数](https://leetcode.cn/problems/number-of-ways-to-buy-pens-and-pencils/) 1400
...
- [ ] [2221. 数组的三角和](https://leetcode.cn/problems/find-triangular-sum-of-an-array/) 1317
...
- [ ] [3518. 最小回文排列 II](https://leetcode.cn/problems/smallest-palindromic-rearrangement-ii/) 2375
...
- [ ] [3470. 全排列 IV](https://leetcode.cn/problems/permutations-iv/) 2474
...
- [ ] [3251. 单调数组对的数目 II](https://leetcode.cn/problems/find-the-count-of-monotonic-pairs-ii/) 2323
...
- [ ] [2652. 倍数求和](https://leetcode.cn/problems/sum-multiples/) 1182
...
- [ ] [2929. 给小朋友们分糖果 II](https://leetcode.cn/problems/distribute-candies-among-children-ii/) 1701
...
- [ ] [1588. 所有奇数长度子数组的和](https://leetcode.cn/problems/sum-of-all-odd-length-subarrays/) 1409
...
- [ ] [3428. 最多 K 个元素的子序列的最值之和](https://leetcode.cn/problems/maximum-and-minimum-sums-of-at-most-size-k-subsequences/) 2028
- [ ] [3426. 所有安放棋子方案的曼哈顿距离](https://leetcode.cn/problems/manhattan-distances-of-all-arrangements-of-pieces/) 2443
- [ ] [2763. 所有子数组中不平衡数字之和](https://leetcode.cn/problems/sum-of-imbalance-numbers-of-all-subarrays/) 2278
...
- [ ] [1230. 抛掷硬币](https://leetcode.cn/problems/toss-strange-coins/) 1809（会员题）
...
- [ ] [3235. 判断矩形的两个角落是否可达](https://leetcode.cn/problems/check-if-the-rectangle-corner-is-reachable/) 3774
- [ ] [1924. 安装栅栏 II](https://leetcode.cn/problems/erect-the-fence-ii/)（会员题）
...
> 另见 [动态规划题单](/lc-rating/v0/list/dynamic_programming) 的「**§11.7 斜率优化 DP**」。

- [ ] [587. 安装栅栏](https://leetcode.cn/problems/erect-the-fence/)
- [ ] [812. 最大三角形面积](https://leetcode.cn/problems/largest-triangle-area/) 1543
...
- [ ] [835. 图像重叠](https://leetcode.cn/problems/image-overlap/) 1970
- [ ] [3549. 两个多项式相乘](https://leetcode.cn/problems/multiply-two-polynomials/)（会员题）
...
- [ ] [3400. 右移后的最大匹配索引数](https://leetcode.cn/problems/maximum-number-of-matching-indices-after-right-shifts/)（会员题）
...
> 见 [位运算题单](/lc-rating/v0/list/bitwise_operations)。
...
- [ ] [2145. 统计隐藏数组数目](https://leetcode.cn/problems/count-the-hidden-sequences/) 1614
...
- [ ] [1823. 找出游戏的获胜者](https://leetcode.cn/problems/find-the-winner-of-the-circular-game/) 1412
...
- [ ] [1515. 服务中心的最佳位置](https://leetcode.cn/problems/best-position-for-a-service-centre/) 2157
...
- [ ] [2443. 反转之后的数字和](https://leetcode.cn/problems/sum-of-number-and-its-reverse/) 1376
- [ ] [1806. 还原排列的最少操作步数](https://leetcode.cn/problems/minimum-number-of-operations-to-reinitialize-a-permutation/) 1491
...
- [ ] [800. 相似 RGB 颜色](https://leetcode.cn/problems/similar-rgb-color/) 1564（会员题）
