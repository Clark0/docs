---
title: 贪心与思维题单
aliases: [贪心算法（基本贪心策略/反悔/区间/字典序/数学/思维/构造）, 灵神贪心与思维题单]
tags:
  - leetcode
  - greedy
  - algorithm
...
original: https://leetcode.cn/circle/discuss/g6KTKL
last_update: 2025-11-19 23:15:19
---

# 贪心算法（基本贪心策略/反悔/区间/字典序/数学/思维/构造）

来源：https://leetcode.cn/circle/discuss/g6KTKL
更新：2025-11-19 23:15:19
...
- [ ] [3627. 中位数之和的最大值](https://leetcode.cn/problems/maximum-median-sum-of-subsequences-of-size-3/) 1262
...
- [ ] [1196. 最多可以买到的苹果数量](https://leetcode.cn/problems/how-many-apples-can-you-put-into-the-basket/) 1249（会员题）
...
- [ ] [2098. 长度为 K 的最大偶数和子序列](https://leetcode.cn/problems/subsequence-of-size-k-with-the-largest-even-sum/)（会员题）
...
- [ ] [2592. 最大化数组的伟大值](https://leetcode.cn/problems/maximize-greatness-of-an-array/) 1569
...
- [ ] [870. 优势洗牌](https://leetcode.cn/problems/advantage-shuffle/) 1648
...
> 读者可以对比下面的题目和 [动态规划题单](/lc-rating/v0/list/dynamic_programming) 中的线性 DP、状态机 DP 的区别，思考什么情况下只能 DP 不能贪心，从而加深对「局部最优」和「全局最优」的理解。
> 另见本题单的「**§3.1 字典序最小/最大**」。
...
- [ ] [1529. 最少的后缀翻转次数](https://leetcode.cn/problems/minimum-suffix-flips/) 1393
...
> 读者可以对比下面的题目和 [动态规划题单](/lc-rating/v0/list/dynamic_programming) 中的划分型 DP 的区别，思考什么情况下只能 DP 不能贪心，从而加深对「局部最优」和「全局最优」的理解。
...
- [x] [1546. 和为目标值且不重叠的非空子数组的最大数目](https://leetcode.cn/problems/maximum-number-of-non-overlapping-subarrays-with-sum-equals-target/) 1855
...
- [ ] [1727. 重新排列后的最大子矩阵](https://leetcode.cn/problems/largest-submatrix-with-rearrangements/) 1927
...
- [ ] [3309. 连接二进制表示可形成的最大数值](https://leetcode.cn/problems/maximum-possible-number-by-binary-concatenation/) 1364
...
- [ ] [984. 不含 AAA 或 BBB 的字符串](https://leetcode.cn/problems/string-without-aaa-or-bbb/) 1474
...
> **变形**：每个区间有各自的分数，从中选一些两两互不相交的区间，最大化得分之和。详见 [动态规划题单](/lc-rating/v0/list/dynamic_programming) 中的「§5.4 不相交区间」。

- [ ] [435. 无重叠区间](https://leetcode.cn/problems/non-overlapping-intervals/)
- [ ] [646. 最长数对链](https://leetcode.cn/problems/maximum-length-of-pair-chain/)
- [ ] [1520. 最多的不重叠子字符串](https://leetcode.cn/problems/maximum-number-of-non-overlapping-substrings/) 2363
- [ ] [3458. 选择 K 个互不重叠的特殊子字符串](https://leetcode.cn/problems/select-k-disjoint-special-substrings/) 2221
...
- [ ] [758. 字符串中的加粗单词](https://leetcode.cn/problems/bold-words-in-string/) 1547（会员题）
- [ ] [3323. 通过插入区间最小化连通组](https://leetcode.cn/problems/minimize-connected-groups-by-inserting-interval/)（会员题）
- [ ] [759. 员工空闲时间](https://leetcode.cn/problems/employee-free-time/) 1710（会员题）
...
- [ ] [2259. 移除指定数字得到的最大结果](https://leetcode.cn/problems/remove-digit-from-number-to-maximize-result/) 1332
- [ ] [2566. 替换一个数字后的最大差值](https://leetcode.cn/problems/maximum-difference-by-remapping-a-digit/) 1396
...
- [ ] [2048. 下一个更大的数值平衡数](https://leetcode.cn/problems/next-greater-numerically-balanced-number/) 1734
...
> 见 [数据结构题单](/lc-rating/v0/list/data_structure) 中的「**§3.4 合法括号字符串**」。
...
- [ ] [2268. 最少按键次数](https://leetcode.cn/problems/minimum-number-of-keypresses/)（会员题）
- [ ] [2561. 重排水果](https://leetcode.cn/problems/rearranging-fruits/) 2222
- [ ] [3547. 图中边值的最大和](https://leetcode.cn/problems/maximum-sum-of-edge-values-in-a-graph/) 2344
...
- [ ] [棋盘整理](https://leetcode.cn/contest/2025_pudong_ai/problems/1Hxnb6/)
- [ ] [296. 最佳的碰头地点](https://leetcode.cn/problems/best-meeting-point/)（会员题）
...
- [ ] [754. 到达终点数字](https://leetcode.cn/problems/reach-a-number/) 1880
...
- [ ] [3471. 找出最大的几近缺失整数](https://leetcode.cn/problems/find-the-largest-almost-missing-integer/) 1308
...
- [ ] [2731. 移动机器人](https://leetcode.cn/problems/movement-of-robots/) 1923
...
- [ ] [3614. 用特殊操作处理字符串 II](https://leetcode.cn/problems/process-string-with-special-operations-ii/) 2011
...
- [ ] [1183. 矩阵中 1 的最大数量](https://leetcode.cn/problems/maximum-number-of-ones/) 2367（会员题）
...
- [ ] [969. 煎饼排序](https://leetcode.cn/problems/pancake-sorting/) 1591
- [ ] [1605. 给定行和列的和求可行矩阵](https://leetcode.cn/problems/find-valid-matrix-given-row-and-column-sums/) 1868
- [ ] [2375. 根据模式串构造最小数字](https://leetcode.cn/problems/construct-smallest-number-from-di-string/) 1642
...
- [ ] [1980. 找出不同的二进制字符串](https://leetcode.cn/problems/find-unique-binary-string/) 1362

## 七、交互题

- [ ] [278. 第一个错误的版本](https://leetcode.cn/problems/first-bad-version/)
- [ ] [374. 猜数字大小](https://leetcode.cn/problems/guess-number-higher-or-lower/)
- [ ] [1237. 找出给定方程的正整数解](https://leetcode.cn/problems/find-positive-integer-solution-for-a-given-equation/) 1405
...
- [ ] [1274. 矩形内船只的数目](https://leetcode.cn/problems/number-of-ships-in-a-rectangle/) 1997（会员题）
...
- [ ] [3523. 非递减数组的最大长度](https://leetcode.cn/problems/make-array-non-decreasing/) 1435
- [ ] [781. 森林中的兔子](https://leetcode.cn/problems/rabbits-in-forest/) 1453
...
- [ ] [3724. 转换数组的最少操作次数](https://leetcode.cn/problems/minimum-operations-to-transform-array/) 1790
...
- [ ] [2732. 找到矩阵中的好子集](https://leetcode.cn/problems/find-a-good-subset-of-the-matrix/) 2240
...
- [ ] [3460. 最多删除一次后的最长公共前缀](https://leetcode.cn/problems/longest-common-prefix-after-at-most-one-removal/)（会员题）
